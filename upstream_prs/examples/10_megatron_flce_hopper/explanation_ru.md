...
4. Forward возвращает loss без материализации логитов; backward
   ...
   и получает ускорение (на H200 NAM56R MBS=10 — 269.4 TFLOP/s
   против ~252 в нефьюженном пути).
...
(подавляющее большинство пользователей NeMo/Megatron). Локально мы
cherry-pick'нули его и проверили: NAM56R 8×H200, MBS=10, FP8 tensorwise,
main-head через fused linear CE — стабильные **269.4 TFLOP/s**, никакой
регрессии относительно Blackwell-пути.
