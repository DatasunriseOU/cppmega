...
| CCE MTP packing      | `CPPMEGA_CCE_MTP_FUSION_MODE=off\|main_mtp\|mtp_only` | `mtp_native_hopper_ce.py` | Exact CCE packing mode; `mtp_only` packs MTP depths into one call while keeping the main CE separate         |
