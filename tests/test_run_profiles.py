...
def test_run_profile_cli_overrides_are_parameters_not_env(capsys, monkeypatch):
    ...
    assert "export CPPMEGA_MXFP8_STORAGE_ISLANDS=frozen_mxfp8" in out
...
def test_mxfp8_storage_islands_render_typed_profile_env():
    ...
    assert env["CPPMEGA_MXFP8_STORAGE_ISLAND_STRUCTURE_UP_PROJ"] == "0"
