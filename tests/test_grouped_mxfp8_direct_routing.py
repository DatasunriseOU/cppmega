...
def test_grouped_mxfp8_gemm_ready_route_uses_existing_operands_without_copy(
    ...
    assert stats["mxfp8_linear_contract_v1_gemm_ready_operand_consumed"] == 0
...
def test_grouped_split_quantize_v1_uses_producer_operands_without_copy(monkeypatch):
    ...
    for quantizer in quantizers:
        ...
        assert quantizer._te_dual_output_quantize_for_backward_enabled is False
    ...
    assert stats["mxfp8_linear_contract_v1_gemm_ready_operand_consumed"] == 2
