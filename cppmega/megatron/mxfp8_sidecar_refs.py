...
These helpers are intentionally free of Transformer Engine and Megatron imports:
unit tests and memory probes need to validate sidecar lifecycle behavior without
loading the full runtime shim and its machine-specific monkey patches.
"""
