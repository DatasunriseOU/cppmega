"""Runtime counters for the Muon quantized-momentum/Newton-Schulz dtype path."""
...
def install_muon_dtype_audit(config: MuonDtypeAuditConfig | None = None) -> bool:
    ...
    The wrappers are observational only. They do not change optimizer tensors or
    math; they record the dtype contract that reaches q8 momentum update and
    Newton-Schulz addmm steps.
    """
