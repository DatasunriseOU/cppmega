...
class PrecisionProfile:
    ...
    # compact_direct_v1 is the strict no-sidecar lane: dense Linear consumes
    # compact-columnwise operands directly and refuses transpose sidecars.
...
def _add_common_profile_overrides(parser: argparse.ArgumentParser) -> None:
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "compact_direct_v1 forbids transpose sidecars and copy bridges."
        ),
    )
    parser.add_argument(
