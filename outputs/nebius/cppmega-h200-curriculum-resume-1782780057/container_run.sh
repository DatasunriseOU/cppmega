...
PREV_CHECKPOINT_ROOT=/data/cppmega_curriculum_checkpoints/stage_01_seq_1024_bs_192
PREV_CUM_ITERS=1421
...
PY
    ...
    if [[ -n \"$PREV_CHECKPOINT_ROOT\" ]]; then
      CHECKPOINT_ARGS+=(--load \"$PREV_CHECKPOINT_ROOT\" --override-opt-param-scheduler)
    fi
