...
| MTP Liger CE: `CPPMEGA_MTP_CE_KERNEL=liger` | `CPPMEGA_I_UNDERSTAND_MTP_LIGER_CE_IS_DEPRECATED=1` | `CPPMEGA_MTP_CE_KERNEL=cce` on GB10, `native` only after retained H200 validation |
