"""Modal runner for the Wave 2 WMMA CUDA chunk-owner prototype."""
...
APP_NAME = "cppmega-mamba3-mono-cuda-chunk-wave2-" + re.sub(r"[^0-9A-Za-z]+", "-", GPU_SPEC).lower()
...
def run_remote(
    ...
    os.environ["RR_DIAG_CUDA_EXT_SUFFIX"] = "mono_wave2_wmma"
    ...
    path = bench_dir / "rr_mono_cuda_chunk_wave2.py"
    module_name = "rr_mono_cuda_chunk_wave2_" + re.sub(r"[^0-9A-Za-z_]+", "_", shape_csv)
