"""Modal runner for the Wave 5 scan-owner CUDA prototype."""
...
APP_NAME = "cppmega-mamba3-mono-cuda-chunk-wave5-" + re.sub(r"[^0-9A-Za-z]+", "-", GPU_SPEC).lower()
...
def run_remote(
    ...
    os.environ["RR_DIAG_CUDA_EXT_SUFFIX"] = "mono_wave5_scan_owner"
    ...
    for module in (
        ...
        "rr_mono_cuda_chunk_wave5",
        "rr_mono_cuda_chunk_wave5_extension",
    ):
        sys.modules.pop(module, None)

    bench_dir = pathlib.Path(CPPMEGA_ROOT) / "upstream_prs/examples/13_tilelang_floormod_dbz"
    sys.path.insert(0, str(bench_dir))
    path = bench_dir / "rr_mono_cuda_chunk_wave5.py"
    module_name = "rr_mono_cuda_chunk_wave5_" + re.sub(r"[^0-9A-Za-z_]+", "_", shape_csv)
