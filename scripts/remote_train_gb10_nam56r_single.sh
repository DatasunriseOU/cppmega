...
#   - cuDNN attention disabled (sm_121 engine issues): --attention-backend flash
...
ssh "${REMOTE_HOST}" "REMOTE_ROOT='${REMOTE_ROOT}' REMOTE_VENV='${REMOTE_VENV}' REMOTE_LOG='${REMOTE_LOG}' CPPMEGA_RUN_ID='${CPPMEGA_RUN_ID}' CPPMEGA_TRAIN_ITERS='${CPPMEGA_TRAIN_ITERS:-5}' CPPMEGA_SEQ_LENGTH='${CPPMEGA_SEQ_LENGTH:-2048}' CPPMEGA_MAX_POSITION_EMBEDDINGS='${CPPMEGA_MAX_POSITION_EMBEDDINGS:-2048}' CPPMEGA_MICRO_BATCH_SIZE='${CPPMEGA_MICRO_BATCH_SIZE:-1}' CPPMEGA_GLOBAL_BATCH_SIZE='${CPPMEGA_GLOBAL_BATCH_SIZE:-1}' CPPMEGA_NGRAM_HASH_ENABLED='${CPPMEGA_NGRAM_HASH_ENABLED:-0}' CPPMEGA_STRUCTURE_ENABLED='${CPPMEGA_STRUCTURE_ENABLED:-0}' CPPMEGA_GB10_USE_DIST_OPT='${CPPMEGA_GB10_USE_DIST_OPT:-0}' CPPMEGA_GB10_CUDA_GRAPH='${CPPMEGA_GB10_CUDA_GRAPH:-1}' CPPMEGA_GB10_CUDA_GRAPH_WARMUP='${CPPMEGA_GB10_CUDA_GRAPH_WARMUP:-3}' CPPMEGA_GB10_SILENCE_ACC_GRAD='${CPPMEGA_GB10_SILENCE_ACC_GRAD:-1}' CPPMEGA_NEM_PATTERN='${CPPMEGA_NEM_PATTERN:-AEMEAEMEAEMR}' CPPMEGA_LAYER_DEPTH='${CPPMEGA_LAYER_DEPTH:-52}' CPPMEGA_R_LAYER_INDICES='${CPPMEGA_R_LAYER_INDICES:-12,24,36,48}' CPPMEGA_HIDDEN_SIZE='${CPPMEGA_HIDDEN_SIZE:-3584}' CPPMEGA_FFN_HIDDEN_SIZE='${CPPMEGA_FFN_HIDDEN_SIZE:-18944}' CPPMEGA_NUM_ATTN_HEADS='${CPPMEGA_NUM_ATTN_HEADS:-28}' CPPMEGA_ENABLE_MOE='${CPPMEGA_ENABLE_MOE:-True}' CPPMEGA_GB10_NSYS_PROFILE='${CPPMEGA_GB10_NSYS_PROFILE:-0}' CPPMEGA_GB10_NSYS_OUTPUT='${CPPMEGA_GB10_NSYS_OUTPUT:-}' CPPMEGA_GB10_NSYS_DELAY='${CPPMEGA_GB10_NSYS_DELAY:-30}' CPPMEGA_GB10_NSYS_DURATION='${CPPMEGA_GB10_NSYS_DURATION:-30}' CPPMEGA_GB10_MOE_DISPATCHER='${CPPMEGA_GB10_MOE_DISPATCHER:-}' bash '${REMOTE_TMP_SCRIPT}' || (status=\$?; echo 'remote nam56r gb10 single-gpu train failed; tail follows:'; tail -n 200 '${REMOTE_LOG}' || true; exit \$status)"
