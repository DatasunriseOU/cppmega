...
# TE otherwise prefers FA3 on Hopper before discovering that NAM56R's unequal
# 128/64 MLA heads require FA4. Both backends remain installed in the image.
export NVTE_FLASH_ATTN_V3="${NVTE_FLASH_ATTN_V3:-0}"
export NVTE_FLASH_ATTN_V4="${NVTE_FLASH_ATTN_V4:-1}"
