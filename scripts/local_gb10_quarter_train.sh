...
if [[ "${CPPMEGA_FP8_RECIPE}" == "mxfp8" || -n "${CPPMEGA_TE_PRECISION_CONFIG_FILE:-}" ]]; then
  ...
  export CPPMEGA_TE_MXFP8_DEFERRED_EMIT_BATCHING="${CPPMEGA_TE_MXFP8_DEFERRED_EMIT_BATCHING:-0}"
  export CPPMEGA_TE_MXFP8_DEFERRED_EMIT_MAX_PENDING_MIB="${CPPMEGA_TE_MXFP8_DEFERRED_EMIT_MAX_PENDING_MIB:-1024}"
  export CPPMEGA_TE_MXFP8_DEFERRED_EMIT_MAX_PENDING_OPERANDS="${CPPMEGA_TE_MXFP8_DEFERRED_EMIT_MAX_PENDING_OPERANDS:-64}"
...
echo "[local-quarter] mxfp8_deferred_emit_batching=${CPPMEGA_TE_MXFP8_DEFERRED_EMIT_BATCHING:-0} max_mib=${CPPMEGA_TE_MXFP8_DEFERRED_EMIT_MAX_PENDING_MIB:-unset} max_operands=${CPPMEGA_TE_MXFP8_DEFERRED_EMIT_MAX_PENDING_OPERANDS:-unset}"
