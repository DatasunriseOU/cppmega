...
if [[ "${CPPMEGA_FP8_RECIPE}" == "mxfp8" || -n "${CPPMEGA_TE_PRECISION_CONFIG_FILE:-}" ]]; then
  ...
  export CPPMEGA_TE_MXFP8_DEFERRED_EMIT_SCHEDULE="${CPPMEGA_TE_MXFP8_DEFERRED_EMIT_SCHEDULE:-inline}"
