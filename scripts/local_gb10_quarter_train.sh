...
if [[ "${CPPMEGA_FP8_RECIPE}" == "mxfp8" || -n "${CPPMEGA_TE_PRECISION_CONFIG_FILE:-}" ]]; then
  ...
  export CPPMEGA_TE_MXFP8_TRANSPOSE_EMIT_BACKEND="${CPPMEGA_TE_MXFP8_TRANSPOSE_EMIT_BACKEND:-off}"
  export CPPMEGA_TE_MXFP8_TRANSPOSE_EMIT_SWIZZLED="${CPPMEGA_TE_MXFP8_TRANSPOSE_EMIT_SWIZZLED:-0}"
  export CPPMEGA_TE_MXFP8_TRANSPOSE_EMIT_STRICT="${CPPMEGA_TE_MXFP8_TRANSPOSE_EMIT_STRICT:-0}"
  export CPPMEGA_CUTLASS_MXFP8_SCALE_BACKEND="${CPPMEGA_CUTLASS_MXFP8_SCALE_BACKEND:-compact}"
  export CPPMEGA_TE_MXFP8_COMPACT_COLUMNWISE_BACKWARD="${CPPMEGA_TE_MXFP8_COMPACT_COLUMNWISE_BACKWARD:-1}"
  export CPPMEGA_TE_MXFP8_GROUPED_DIRECT_BACKWARD="${CPPMEGA_TE_MXFP8_GROUPED_DIRECT_BACKWARD:-1}"
...
echo "[local-quarter] mxfp8_bwd_tn_adapter=${CPPMEGA_TE_MXFP8_BWD_TN_ADAPTER:-0} mxfp8_bwd_backend=${CPPMEGA_TE_MXFP8_BWD_BACKEND:-cutlass_native} transpose_emit=${CPPMEGA_TE_MXFP8_TRANSPOSE_EMIT_BACKEND:-off} transpose_emit_swizzled=${CPPMEGA_TE_MXFP8_TRANSPOSE_EMIT_SWIZZLED:-0} cutlass_scale_backend=${CPPMEGA_CUTLASS_MXFP8_SCALE_BACKEND:-compact} compact_columnwise_backward=${CPPMEGA_TE_MXFP8_COMPACT_COLUMNWISE_BACKWARD:-1} grouped_direct_backward=${CPPMEGA_TE_MXFP8_GROUPED_DIRECT_BACKWARD:-1} bf16_fallback=${CPPMEGA_TE_MXFP8_BWD_ALLOW_BF16_FALLBACK:-0} nvte_backward_override=${NVTE_BACKWARD_OVERRIDE:-}"
