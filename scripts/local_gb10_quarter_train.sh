...
export CPPMEGA_NSYS_LAUNCH_MODE="${CPPMEGA_NSYS_LAUNCH_MODE:-external_torchrun}"
export CPPMEGA_NSYS_TRACE="${CPPMEGA_NSYS_TRACE:-cuda-sw,nvtx,osrt}"
export CPPMEGA_NSYS_CUDA_TRACE_SCOPE="${CPPMEGA_NSYS_CUDA_TRACE_SCOPE:-process-tree}"
...
export CPPMEGA_NCU_PROFILE="${CPPMEGA_NCU_PROFILE:-0}"
export CPPMEGA_NCU_OUTPUT="${CPPMEGA_NCU_OUTPUT:-/home/dave/logs/${RUN_ID}_ncu}"
export CPPMEGA_NCU_SET="${CPPMEGA_NCU_SET:-basic}"
export CPPMEGA_NCU_LAUNCH_COUNT="${CPPMEGA_NCU_LAUNCH_COUNT:-64}"
export CPPMEGA_NCU_TARGET_PROCESSES="${CPPMEGA_NCU_TARGET_PROCESSES:-all}"
export CPPMEGA_NCU_PROFILE_FROM_START="${CPPMEGA_NCU_PROFILE_FROM_START:-0}"
