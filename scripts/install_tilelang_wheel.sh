#!/usr/bin/env bash
# Install TileLang 0.1.9 from DatasunriseOU/tilelang@fff5cfcc into the active
# (or given) venv.
#
...
# via vendored TVM DatasunriseOU/tvm@ada9cffb), restores the nvbench CUDA
...
# CUDA 13.2 TVM runtime, and its matching tvm-ffi wheel is v0.1.13.post1.
...
TVM_FFI_WHEEL_URL="${TVM_FFI_WHEEL_URL:-sftp://BUCKET_ARTIFACTS/tilelang/apache_tvm_ffi-0.1.13.post1-cp313-cp313-linux_x86_64.whl}"
GIT_COMMIT="${TILELANG_GIT_COMMIT:-fff5cfcc60fed16d163f13cca991256b6ebe1573}"
TVM_COMMIT="${TILELANG_TVM_COMMIT:-ada9cffbb381695651e265039f77c326c146d6b7}"
TVM_FFI_COMMIT="${TILELANG_TVM_FFI_COMMIT:-4e74cb45fbcf6117b69a9864bbe5548f1a7e17a2}"
...
if observed_ffi != "0.1.13.post1":
    raise SystemExit(f"unexpected tvm-ffi version: {observed_ffi!r} != '0.1.13.post1'")
PY
}
