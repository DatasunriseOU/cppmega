"""Modal runner for the Wave 3 WMMA CUDA chunk-owner schedule prototype."""
...
APP_NAME = "cppmega-mamba3-mono-cuda-chunk-wave3-" + re.sub(r"[^0-9A-Za-z]+", "-", GPU_SPEC).lower()
...
def run_remote(
    ...
    os.environ["RR_DIAG_CUDA_EXT_SUFFIX"] = "mono_wave3_wmma_triangular"
    ...
    path = bench_dir / "rr_mono_cuda_chunk_wave3.py"
    module_name = "rr_mono_cuda_chunk_wave3_" + re.sub(r"[^0-9A-Za-z_]+", "_", shape_csv)
